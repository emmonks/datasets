...
df = pd.read_csv (r'/home/core/Capturas/Senac/transilvania_outro/todos.txt')
...
df2['mean_fiat'] = df2['mean_fiat'] / 1000
df2['mean_biat'] = df2['mean_biat'] / 1000

print ("Transilvania")

# group by Team, get mean, min, and max value of Age for each value of Team.
grouped_single1 = df2.groupby('label').agg({'mean_fiat': ['mean', 'min', 'max', 'std']})
grouped_single2 = df2.groupby('label').agg({'mean_biat': ['mean', 'min', 'max', 'std']})
