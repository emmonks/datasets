import pandas as pd
df = pd.read_csv (r'/tmp/CONV/twitch1_live.pcapng.pcap.txt')
...
fpackets = df['total_bpackets'].mean()
bpackets = df['total_fpackets'].mean()
rpackets = (bpackets/fpackets) * 100

print "----------------------------"
print "Dataset privado - Twitch"
print "----------------------------"
