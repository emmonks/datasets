import pandas as pd
df = pd.read_csv (r'/tmp/CONV/globo_live_06072021_a.pcapng.pcap.txt')
df2 = pd.read_csv (r'/tmp/CONV/globo_live_06072021_b.pcapng.pcap.txt')
...
fpackets1 = df['total_bpackets'].mean()
bpackets1 = df['total_fpackets'].mean()
rpackets1 = (bpackets1/fpackets1) * 100
...
fpackets2 = df2['total_bpackets'].mean()
bpackets2 = df2['total_fpackets'].mean()
rpackets2 = (bpackets2/fpackets2) * 100



print "----------------------------"
print "Dataset privado - Globo (Live)"
print "----------------------------"
...
print ('Relation Bpackets/Fpackets (%): ' + str(rpackets1))
...
print ('Relation Bpackets/Fpackets (%): ' + str(rpackets2))
